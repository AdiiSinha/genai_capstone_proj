# Central enterprise datasets ported from frontend data.js

TEAMS = [
    {"person": "Rahul Mehta", "project": "Phoenix", "text": "Can you review the deployment approval before 5 PM today?", "priority": "critical"},
    {"person": "Neha Kapoor", "project": "Atlas", "text": "I'm still waiting for the database credentials from DevOps.", "priority": "high"},
    {"person": "Vikram Rao", "project": "Phoenix", "text": "Client demo is at 4 PM. Please verify the login defect before the demo.", "priority": "high"},
    {"person": "Ananya Singh", "project": "Nova", "text": "I'll share the test report by EOD.", "priority": "medium"},
    {"person": "HR Bot", "project": "People", "text": "Join the wellness program this month. Registration is open.", "priority": "low"},
    {"person": "Daily Digest", "project": "General", "text": "Capgemini daily digest: campus and learning updates.", "priority": "low"},
    {"person": "Facilities", "project": "Workplace", "text": "Shuttle B is operating from Gate 2 every 20 minutes.", "priority": "low"}
]

TASKS = [
    {"title": "Review Phoenix deployment approval", "project": "Phoenix", "due": "Today · 5:00 PM", "priority": "critical", "why": "Blocks deployment."},
    {"title": "Verify Atlas login defect", "project": "Atlas", "due": "Today · 3:30 PM", "priority": "high", "why": "Client demo is at 4 PM."},
    {"title": "Send Nova test report", "project": "Nova", "due": "Today · EOD", "priority": "medium", "why": "You committed to share it."},
    {"title": "Complete security training", "project": "Learning", "due": "Tomorrow", "priority": "low", "why": "Training deadline."}
]

ROOMS = [
    {"name": "Orion 1", "floor": "4F", "capacity": 8, "available": True, "nextFree": "3:30 PM"},
    {"name": "Orion 2", "floor": "4F", "capacity": 12, "available": False, "nextFree": "4:15 PM"},
    {"name": "Sirius", "floor": "5F", "capacity": 6, "available": True, "nextFree": "5:00 PM"}
]

BUSES = [
    {"route": "Shuttle A", "destination": "Whitefield → Campus", "gate": "Gate 1", "eta": "6 min"},
    {"route": "Shuttle B", "destination": "KR Puram → Campus", "gate": "Gate 2", "eta": "14 min"},
    {"route": "Buggy 03", "destination": "Campus internal", "gate": "Main Lobby", "eta": "2 min"}
]

NEWS = [
    {"icon": "⚡", "title": "Campus maintenance notice", "summary": "Check the latest facilities email for scheduled maintenance timing."},
    {"icon": "✦", "title": "Wellness program", "summary": "Join the employee wellness program. Registration is open."},
    {"icon": "◈", "title": "Capgemini Daily Digest", "summary": "Daily learning, people and campus updates."}
]
